            ...
            for idx in range(nodes_length):
                ...
                if is_debug_mode:
                    ...
                    for debug_idx in range(8):
                        print(debug_idx-2,": val#8:",format_dict_array[(idx+debug_idx+nodes_length-2)%nodes_length]['code'],'-(',format_dict_array[(idx+debug_idx+nodes_length-2)%nodes_length]['distance'],')')
